...
<div id="k2Container" class="itemListDoctorsView itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemList itemListDoctors">
		...
		<div class="itemListLeading equal-height equal-height-child">
			...
			if((($key+1)%($this->params->get('num_leading_columns'))==0) || count($this->leading)<$this->params->get('num_leading_columns'))
				$lastContainer= ' col itemContainerLast';
			else
				$lastContainer=' col';
			?>
		...
		<!-- Secondary items -->
		<div class="itemListSecondary equal-height equal-height-child">
