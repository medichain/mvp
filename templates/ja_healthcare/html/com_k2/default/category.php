...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
			...
			<div class="subCategoryContainer<?php echo $lastContainer; ?>"<?php echo (count($this->subCategories)==1) ? '' : ' style="width:'.number_format(100/$this->params->get('subCatColumns'), 1).'%;"'; ?>>
				<div class="subCategory">
					<div class="subCategoryImage">
						...
						<!-- Subcategory more... -->
						<a class="btn btn-border subCategoryMore" href="<?php echo $subCategory->link; ?>">
	...
	<div class="itemList">
		...
		<!-- Leading items -->
		<div id="itemListLeading" class="<?php if($this->params->get('num_leading_columns') > 1): echo 'itemColumns'; endif; ?>">
		...
		<!-- Primary items -->
		<div id="itemListPrimary" class="<?php if($this->params->get('num_primary_columns') > 1): echo 'itemColumns'; endif; ?>">
		...
		<!-- Secondary items -->
		<div id="itemListSecondary" class="<?php if($this->params->get('num_secondary_columns') > 1): echo 'itemColumns'; endif; ?>">
