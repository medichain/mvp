...
?>
<div class="blog blog-department <?php echo $this->pageclass_sfx;?>">
	...
	<?php foreach ($this->intro_items as $key => &$item) : ?>
		...
		<?php endif; ?>
			<div class="col-sm-6 col-md-<?php echo round((12 / $this->columns));?>">
				<div data-animation="pop-up" data-delay="item-<?php echo $key; ?>" class="item ja-animate column-<?php echo $rowcount;?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?>">
					<?php
					$this->item = &$item;
					echo $this->loadTemplate('item');
				?>
